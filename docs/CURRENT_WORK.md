...
- **2026-07-19 upstream tracking `b70adcb5..e447cb86`** (19 commits, two passes) — the #194 loader stack landed+closed upstream (doctor skew check, cache-validation), transitive-void ADR-100 WD4, type-of plugin-env parity, IO/File line-iteration non-escape; all absorbed with the harness unchanged.
