...
inference mechanism). Pre-existing FPs: #139, #140, #146, #151, #153. Coverage: #141 (`fb781023`,
3,002 of the 3,829 gaps, ready-for-agent), #144 (unmeasured); #142/#143/#145 closed at
0 rows (`.out-of-scope/`). Still open: #129, #130, #132 (ready-for-agent). `0.4.0` is untagged; ADR-109 drops `int<min,max>` there.
...
State (verified 2026-09-25, at `e59b7b89`): harness **113 fixtures / 0
unregistered extras / 0 registered divergences**, coverage 609/658; standing
