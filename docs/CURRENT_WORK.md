...
the frozen-index arc — #94 (Pass 4b cost), then the LSP layered-index
slice; LSP v4+ (`rootUri`, UTF-16 sync). The narrowing frontier stays OUT OF CARRIER
