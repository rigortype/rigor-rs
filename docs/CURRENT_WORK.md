...
the narrowing frontier stays OUT OF CARRIER LEVERS. Open from this bump: **#128**
(the store-value classifier is syntactic — an FP the sweep cannot reach), **#129**
(`conforms-to` unread, which is why `data/capability_roles/` is unvendored) and
**#130** (ADR-109 bounded ranges); #121 and #124 still stand.
