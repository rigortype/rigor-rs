...
#
# The control: WITHOUT `set` the `key: value` pass DOES consume the comment
# (`fileencoding=binary` is swallowed as `vim`'s value), the fallback never
# runs, and the file stays UTF-8 — m1 fires on both engines (probed).
#
