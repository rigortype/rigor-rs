...
#
# A free-scan `coding:` anywhere in the honored comment resolves through
# the fallback (the pair pass fails on `this` before reaching `coding`) —
# non-UTF-8.
#
