...
#
# Emacs `-*-` pairs apply in order — the LAST encoding key wins — so this
# one resolves UTF-8 and m1 FIRES on both engines (the r2 `.all()` gate
# silenced it; probed).
#
